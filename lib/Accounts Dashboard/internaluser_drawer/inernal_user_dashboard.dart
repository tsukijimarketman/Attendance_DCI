...
import 'package:attendance_app/Accounts%20Dashboard/internaluser_drawer/usermanagement_su.dart';
...
// This will shpw a Toast if the User Have something in his profile that is not completed
  ...
  Widget build(BuildContext context) {
    ...
    final sidebarProvider = Provider.of<InternalSidebarProvider>(context);
    return Scaffold(
