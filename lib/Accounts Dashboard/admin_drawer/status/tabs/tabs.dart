import 'package:attendance_app/Accounts%20Dashboard/admin_drawer/status/tabs/attendance/attendance.dart';
import 'package:attendance_app/Accounts%20Dashboard/admin_drawer/status/tabs/details/details.dart';
import 'package:attendance_app/Accounts%20Dashboard/admin_drawer/status/tabs/minutes/minutes_of_meeting.dart';
import 'package:attendance_app/Accounts%20Dashboard/admin_drawer/status/tabs/qrcode/qr.dart';
  ...
  void _updateAvailableTabs() {
    ...
    switch (widget.statusType) {
      ...
      case 'Cancelled':
        ...
        break;
      default:
        _availableTabs = {0: true, 1: true, 2: true, 3: true}; 
    }
