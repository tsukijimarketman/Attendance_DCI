...
class ManagerAppointmentManager extends StatefulWidget {
  const ManagerAppointmentManager({Key? key}) : super(key: key);

  @override
  _ManagerAppointmentManagerState createState() => _ManagerAppointmentManagerState();
}

class _ManagerAppointmentManagerState extends State<ManagerAppointmentManager> {
