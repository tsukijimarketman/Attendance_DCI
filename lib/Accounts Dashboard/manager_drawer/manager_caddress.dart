...
class ManagerCurrentAddressPick extends StatefulWidget {
  const ManagerCurrentAddressPick({super.key});

  @override
  State<ManagerCurrentAddressPick> createState() => _ManagerCurrentAddressPickState();
}

class _ManagerCurrentAddressPickState extends State<ManagerCurrentAddressPick> {
                ...
                RegionDropdown(
                  ...
                  onChanged: (String? newRegion) {
                    ...
                    _loadProvincesOrCities(
                        Provider.of<ManagerAddressProvider>(context, listen: false)
                            .selectedRegionCode!);
                  },
                ),
            ...
            if (selectedBarangay != null) ...[
              Container(
                  child: Row(
                    ...
                    ZipcodeTextField(
                        initialValue:
                            Provider.of<ManagerAddressProvider>(context).zipcode),
                    SizedBox(width: MediaQuery.of(context).size.width / 50),
                    HouseNumberTextField(
                        initialValue:
                            Provider.of<ManagerAddressProvider>(context).houseNumber),
                    SizedBox(width: MediaQuery.of(context).size.width / 50),
                    StreetTextField(initialValue: Provider.of<ManagerAddressProvider>(context).street),
                    SizedBox(width: MediaQuery.of(context).size.width / 50),
                    //here
                    SubdivisionTextField(initialValue: Provider.of<ManagerAddressProvider>(context).subdivision),
                  ]))
            ],
          ],
        ),
        ...
        Container(
          ...
          child: DropDownTextField(
            onChanged: (selected) {
              ...
              Provider.of<ManagerAddressProvider>(context, listen: false).updateRegion(
...
class _StreetTextFieldState extends State<StreetTextField> {
  ...
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    final addressProvider = Provider.of<ManagerAddressProvider>(context, listen: false);
