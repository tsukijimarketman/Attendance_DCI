...
class ManagerAccountInfo extends StatefulWidget {
  const ManagerAccountInfo({super.key});

  @override
  State<ManagerAccountInfo> createState() => _ManagerAccountInfoState();
}

class _ManagerAccountInfoState extends State<ManagerAccountInfo> {
