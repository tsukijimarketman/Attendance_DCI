...
import 'package:attendance_app/Accounts%20Dashboard/manager_drawer/status/tabs/tabs.dart';
...
class ManagerAppointmentView extends StatefulWidget {
  final String statusType; // This will hold the selected status type

  const ManagerAppointmentView({super.key, required this.statusType});

  @override
  State<ManagerAppointmentView> createState() => _ManagerAppointmentViewState();
}

class _ManagerAppointmentViewState extends State<ManagerAppointmentView> {
