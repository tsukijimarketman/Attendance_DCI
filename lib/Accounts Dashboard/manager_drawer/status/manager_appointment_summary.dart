import 'dart:async';
import 'package:attendance_app/Accounts%20Dashboard/manager_drawer/status/manager_appointment_view.dart';
...
class ManagerAppointmentStatus extends StatefulWidget {
  const ManagerAppointmentStatus({super.key});

  @override
  State<ManagerAppointmentStatus> createState() => _ManagerAppointmentStatusState();
}

class _ManagerAppointmentStatusState extends State<ManagerAppointmentStatus> {
...
if (querySnapshot.docs.isEmpty) {
  throw Exception('User document not found');
    ...
    if (firstName == null || lastName == null) {
      throw Exception('First or last name is missing');
    }
    ...
    Map<String, int> tempCounts = {
      ...
      final snapshot = await _firestore
          ...
          .where('createdBy', isEqualTo: fullName) // 👈 Query by fullName
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    ManagerAppointmentView(statusType: 'Scheduled')));
                      },
                      child: Container(
                        width: width / 5.5,
                        height: width / 9.5,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ManagerAppointmentView(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    ManagerAppointmentView(statusType: 'Completed')));
                      },
                      child: Container(
                        width: width / 5.5,
                        height: width / 9.5,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    ManagerAppointmentView(statusType: 'Cancelled')));
                      },
                      child: Container(
                        width: width / 5.5,
                        height: width / 9.5,
