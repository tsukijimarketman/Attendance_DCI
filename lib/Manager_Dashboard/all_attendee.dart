...
class AllAttendee extends StatelessWidget {
  final String selectedAgenda;

  const AllAttendee({super.key, required this.selectedAgenda});
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: const [
                    ...
                    Expanded(child: Text('Contact Num', style: TextStyle(fontWeight: FontWeight.bold))),
                  ],
                ),
              ),
